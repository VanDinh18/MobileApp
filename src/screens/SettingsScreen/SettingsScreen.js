    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          <TouchableOpacity onPress={() => this.uploadFile('coverimage')}>
            <Image
              style={{height: DEVICE_HEIGHT / 4, width: DEVICE_WIDTH}}
              source={
                this.state.user.coverimage
                  ? {uri: this.state.user.coverimage}
                  : null
              }
            />
          </TouchableOpacity>
          <View
            style={{
              position: 'absolute',
              zIndex: 2,
              top: DEVICE_HEIGHT / 4 - DEVICE_WIDTH / 8,
              flexDirection: 'column',
              alignItems: 'center',
            }}>
            <TouchableOpacity onPress={() => this.uploadFile('avatar')}>
              <Image
                style={{
