...
class AddFriendToGroupExistScreen extends Component {
  ...
  _isMounted = false;
  goback() {
    this.props.navigation.navigate('MultiChatScreen', {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.groupname}>
          <Image
            style={{height: 50, width: 50, borderRadius: 50, marginLeft: 10}}
            source={
          ...
          />
          <Text style={{flex: 1, fontWeight: 'bold', fontSize: 20, padding: 10}}>
